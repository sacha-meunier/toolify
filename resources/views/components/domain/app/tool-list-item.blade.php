...
@if ($tool->trashed())
    <div class="flex items-center gap-3 px-4 py-3.5 opacity-60 lg:gap-6 lg:px-6">
...
@else
    <div class="flex flex-wrap items-center gap-3 px-4 py-3.5 hover:bg-muted lg:flex-nowrap lg:px-6">
