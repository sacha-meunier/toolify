...
<div class="flex flex-col" x-data="{ confirming: false }">
    <x-domain.app.topbar>
        ...
        <x-slot:actions>
            ...
            <x-ui.button variant="primary" size="sm" :label="__('app/settings/workspace/general.save_changes')" wire:click="save" x-bind:disabled="! ($wire.$dirty('form') || $wire.form.logo)"/>
        </x-slot:actions>
    </x-domain.app.topbar>
