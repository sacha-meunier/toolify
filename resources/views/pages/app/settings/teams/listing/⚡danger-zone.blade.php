...
<div class="flex h-full min-h-0 flex-col">
    ...
    <div class="min-h-0 flex-1 overflow-y-auto">
        ...
        >
            ...
            <x-ui.confirm-modal
                :heading="__('app/settings/teams/listing/danger-zone.modal_heading')"
                :description="__('app/settings/teams/listing/danger-zone.modal_description', ['name' => $team->name])"
                :cancel-label="__('app/settings/teams/listing/danger-zone.cancel')"
            >
                <x-slot:body>
